...
<section class="mx-4 lg:mx-auto min-h-full flex flex-col md:justify-end">
	<div class="max-w-2xl mx-auto mt-12 flex-1">
	...
	<footer
		class="max-w-4xl w-full mx-auto flex flex-col md:flex-row gap-4 md:items-center justify-between px-2 lg:px-4 py-1 border border-chalkboard-30 dark:border-chalkboard-90 border-b-0 text-xs text-chalkboard-70 dark:text-chalkboard-40"
	>
		<p>
			Built with the{' '}
